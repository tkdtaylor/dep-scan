...
| 089 | Public-key export for consumers (ADR 007 point 3) | 089-pubkey-export-test-spec.md | 19/19 | 🟡 (code merged; L4: cargo test 830 passed + clippy clean + fmt clean; L3: runtime `dep-scan signing export-pubkey > pubkey.pem` produces `# key-id:` + PEM SPKI, exit 0; ed25519_keyid reused from interchange_sign) |
