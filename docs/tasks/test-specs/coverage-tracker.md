...
| 093 | Surface git deps in scan output (ADR 008 piece 1 — visibility deliverable) | 093-surface-git-deps-in-scan-output-test-spec.md | 13/13 | 🟡 (code merged — L4: cargo test 891 passed + clippy clean + fmt clean; Verified by: L3: cargo test/clippy/fmt; all T-093-01 through T-093-13 markers covered in src/) |
