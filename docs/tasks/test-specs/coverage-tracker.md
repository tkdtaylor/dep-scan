...
| 084 | Scan-result SBOM: CycloneDX + SPDX of analyzed tree (ADR 005 Q2) | 084-scan-result-sbom-test-spec.md | 20/20 | 🟡 Verified by: L2: cargo test 731 passed (22 new T-084 tests) + L2: clippy clean + L2: fmt clean |
