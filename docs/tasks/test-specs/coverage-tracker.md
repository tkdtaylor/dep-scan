...
| 087 | Signing identity: keyless-online + operator-key-offline (ADR 006 Q5, ADR 007) | 087-signing-identity-keyless-offline-test-spec.md | 17/17 | 🟡 (code merged on task/087 branch; T-087-01..16 covered by unit + integration tests, T-087-17 = tooling gate; live ephemeral signer replaced by resolve_signer; Verified by: L4 fitness — cargo test 790+ unit / 3 fail-closed integration pass, clippy -D warnings clean, fmt clean, audit clean; awaiting spec-verifier + operator run) |
